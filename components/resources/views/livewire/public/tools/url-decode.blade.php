<div>
      ...
      <form wire:submit.prevent="onUrlDecode">
        ...
        <div class="form-group mb-3">
            <textarea class="form-control" wire:model.defer="url" rows="10" placeholder="{{ __('Paste your url here...') }}" required></textarea>
        </div>
        ...
        <div class="form-group">
          ...
          @if ( !empty($data) )
            <div class="form-group position-relative mt-3">
                <textarea id="text" class="form-control" rows="10">{{ $data['url'] }}</textarea>
