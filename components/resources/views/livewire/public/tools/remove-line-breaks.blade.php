      ...
      <form wire:submit.prevent="onRemoveLineBreaks">
        ...
        <div class="form-group mb-3">
            <label class="form-check">
                <input class="form-check-input" type="radio" wire:model.defer="para_option" value="no_paragraphs" />
                <span class="form-check-label">{{ __('Remove line breaks only') }}</span>
            </label>
            <label class="form-check">
                <input class="form-check-input" type="radio" wire:model.defer="para_option" value="paragraphs" />
